...
// Config
const EXCEL_PATH = process.env.EIGHT_INCH_EXCEL || '/Users/yipengli/Desktop/cake_name3.xlsx';
...
const CATEGORY_ID = 'eight-inch-cake';
const CATEGORY_NAME = '8寸蛋糕';
const ASSET_DIR = path.resolve(__dirname, '..', 'miniprogram', 'assets', 'eight-inch-cake');
...
async function main(){
  ...
  console.log(`[EIGHT-INCH] rows:${outProducts.length}, assets:${ASSET_DIR}`);
}
